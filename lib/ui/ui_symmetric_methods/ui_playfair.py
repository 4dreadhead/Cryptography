...
class UiPlayfair(object):
    ...
    label_Playfair_gif: QtWidgets.QLabel
    ...
    def setupUi(self, Playfair):
        ...
        Playfair.resize(800, 650)
        Playfair.setMinimumSize(QtCore.QSize(800, 650))
        Playfair.setMaximumSize(QtCore.QSize(800, 650))
        Playfair.setStyleSheet("background-color: rgb(32, 28, 42);")

        self.centralwidget = QtWidgets.QWidget(Playfair)
        self.centralwidget.setObjectName("centralwidget")

        self.label_Playfair_gif = QtWidgets.QLabel(self.centralwidget)
        self.label_Playfair_gif.setGeometry(QtCore.QRect(30, 30, 431, 221))
        self.label_Playfair_gif.setObjectName("label_Playfair_gif")
        gif = QtGui.QMovie("lib/media/playfair.gif")
        self.label_Playfair_gif.setMovie(gif)
        gif.start()
    ...
    def retranslateUi(self, Playfair):
        ...
        self.pushButton_encrypt.setText(_translate("Playfair", "Зашифровать"))
        self.pushButton_decrypt.setText(_translate("Playfair", "Расшифровать"))
        self.pushButton_paste.setText(_translate("Playfair", "Вставить"))
        self.pushButton_clearInput.setText(_translate("Playfair", "Копировать"))
        self.pushButton_copy.setText(_translate("Playfair", "Очистить"))
        self.pushButton_clearOutput.setText(_translate("Playfair", "Очистить"))
        self.pushButton_exit.setText(_translate("Playfair", "Закрыть окно"))

        self.textBrowser.setHtml(_translate("Playfair", UiHelper.text_browser_html()))
        self.label_info_key.setText(_translate("Playfair", "⟵ Введите ключ"))
